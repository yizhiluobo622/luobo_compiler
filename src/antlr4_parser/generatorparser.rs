// Generated from generator.g4 by ANTLR 4.8
#![allow(dead_code)]
...
type BaseParserType<'input, I> =
	BaseParser<'input,generatorParserExt<'input>, I, generatorParserContextType , dyn generatorListener<'input> + 'input >;

type TokenType<'input> = <LocalTokenFactory<'input> as TokenFactory<'input>>::Tok;
pub type LocalTokenFactory<'input> = CommonTokenFactory;

pub type generatorTreeWalker<'input,'a> =
	ParseTreeWalker<'input, 'a, generatorParserContextType , dyn generatorListener<'input> + 'a>;

/// Parser for generator grammar
pub struct generatorParser<'input,I,H>
where
...
impl<'input, I, H> generatorParser<'input, I, H>
where
    I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>,
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
...
impl<'input, I> generatorParser<'input, I, DynStrategy<'input,I>>
where
    I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>,
{
...
impl<'input, I> generatorParser<'input, I, DefaultErrorStrategy<'input,generatorParserContextType>>
where
    I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>,
{
...
/// Trait for monomorphized trait object that corresponds to the nodes of parse tree generated for generatorParser
pub trait generatorParserContext<'input>:
	for<'x> Listenable<dyn generatorListener<'input> + 'x > + 
	ParserRuleContext<'input, TF=LocalTokenFactory<'input>, Ctx=generatorParserContextType>
{}

antlr_rust::coerce_from!{ 'input : generatorParserContext<'input> }

impl<'input> generatorParserContext<'input> for TerminalNode<'input,generatorParserContextType> {}
impl<'input> generatorParserContext<'input> for ErrorNode<'input,generatorParserContextType> {}

antlr_rust::tid! { impl<'input> TidAble<'input> for dyn generatorParserContext<'input> + 'input }

antlr_rust::tid! { impl<'input> TidAble<'input> for dyn generatorListener<'input> + 'input }

pub struct generatorParserContextType;
antlr_rust::tid!{generatorParserContextType}

impl<'input> ParserNodeType<'input> for generatorParserContextType{
	type TF = LocalTokenFactory<'input>;
	type Type = dyn generatorParserContext<'input> + 'input;
}

impl<'input, I, H> Deref for generatorParser<'input, I, H>
where
    I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>,
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
...
impl<'input, I, H> DerefMut for generatorParser<'input, I, H>
where
    I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>,
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
...
pub struct generatorParserExt<'input>{
	_pd: PhantomData<&'input str>,
}

impl<'input> generatorParserExt<'input>{
}
antlr_rust::tid! { generatorParserExt<'a> }

impl<'input> TokenAware<'input> for generatorParserExt<'input>{
	type TF = LocalTokenFactory<'input>;
}

impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> ParserRecog<'input, BaseParserType<'input,I>> for generatorParserExt<'input>{}

impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> Actions<'input, BaseParserType<'input,I>> for generatorParserExt<'input>{
	fn get_grammar_file_name(&self) -> & str{ "generator.g4"}

   	fn get_rule_names(&self) -> &[& str] {&ruleNames}

   	fn get_vocabulary(&self) -> &dyn Vocabulary { &**VOCABULARY }
	fn sempred(_localctx: Option<&(dyn generatorParserContext<'input> + 'input)>, rule_index: isize, pred_index: isize,
			   recog:&mut BaseParserType<'input,I>
	)->bool{
		match rule_index {
					4 => generatorParser::<'input,I,_>::postfixExpression_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
					48 => generatorParser::<'input,I,_>::directDeclarator_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
					59 => generatorParser::<'input,I,_>::directAbstractDeclarator_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
			_ => true
		}
	}
}
...
impl<'input> generatorParserContext<'input> for PrimaryExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for PrimaryExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
			listener.enter_primaryExpression(self);
		}fn exit(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for PrimaryExpressionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = generatorParserContextType;
...
impl<'input> PrimaryExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<PrimaryExpressionContextAll<'input>> {
		Rc::new(
...
pub trait PrimaryExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<PrimaryExpressionContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token Identifier
/// Returns `None` if there is no child corresponding to token Identifier
fn Identifier(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Constant(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(Constant, 0)
}
/// Retrieves all `TerminalNode`s corresponding to token StringLiteral in current rule
fn StringLiteral_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
...
fn StringLiteral(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn LeftParen(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn RightParen(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for GenericSelectionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for GenericSelectionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> GenericSelectionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<GenericSelectionContextAll<'input>> {
		Rc::new(
...
pub trait GenericSelectionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<GenericSelectionContextExt<'input>>{
...
fn Generic(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Comma(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for GenericAssocListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for GenericAssocListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> GenericAssocListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<GenericAssocListContextAll<'input>> {
		Rc::new(
...
pub trait GenericAssocListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<GenericAssocListContextExt<'input>>{
...
fn Comma_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
/// Retrieves 'i's TerminalNode corresponding to token Comma, starting from 0.
/// Returns `None` if number of children corresponding to token Comma is less or equal than `i`.
fn Comma(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for GenericAssociationContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for GenericAssociationContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> GenericAssociationContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<GenericAssociationContextAll<'input>> {
		Rc::new(
...
pub trait GenericAssociationContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<GenericAssociationContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token Colon
/// Returns `None` if there is no child corresponding to token Colon
fn Colon(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Default(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for PostfixExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for PostfixExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> PostfixExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<PostfixExpressionContextAll<'input>> {
		Rc::new(
...
pub trait PostfixExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<PostfixExpressionContextExt<'input>>{
...
fn LeftBracket(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn RightBracket(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn PlusPlus(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn MinusMinus(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(MinusMinus, 0)
}
/// Retrieves first TerminalNode corresponding to token Dot
/// Returns `None` if there is no child corresponding to token Dot
fn Dot(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Arrow(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for ArgumentExpressionListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ArgumentExpressionListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ArgumentExpressionListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ArgumentExpressionListContextAll<'input>> {
		Rc::new(
...
pub trait ArgumentExpressionListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ArgumentExpressionListContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for UnaryExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for UnaryExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> UnaryExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<UnaryExpressionContextAll<'input>> {
		Rc::new(
...
pub trait UnaryExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<UnaryExpressionContextExt<'input>>{
...
fn Sizeof(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Alignof(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for UnaryOperatorContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for UnaryOperatorContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> UnaryOperatorContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<UnaryOperatorContextAll<'input>> {
		Rc::new(
...
pub trait UnaryOperatorContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<UnaryOperatorContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token And
/// Returns `None` if there is no child corresponding to token And
fn And(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Star(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(Star, 0)
}
/// Retrieves first TerminalNode corresponding to token Plus
/// Returns `None` if there is no child corresponding to token Plus
fn Plus(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(Plus, 0)
}
/// Retrieves first TerminalNode corresponding to token Minus
/// Returns `None` if there is no child corresponding to token Minus
fn Minus(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Tilde(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Not(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for CastExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for CastExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> CastExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<CastExpressionContextAll<'input>> {
		Rc::new(
...
pub trait CastExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<CastExpressionContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for MultiplicativeExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for MultiplicativeExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> MultiplicativeExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<MultiplicativeExpressionContextAll<'input>> {
		Rc::new(
...
pub trait MultiplicativeExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<MultiplicativeExpressionContextExt<'input>>{
...
fn Star_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn Star(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(Star, i)
}
/// Retrieves all `TerminalNode`s corresponding to token Div in current rule
fn Div_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn Div(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(Div, i)
}
/// Retrieves all `TerminalNode`s corresponding to token Mod in current rule
fn Mod_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn Mod(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for AdditiveExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for AdditiveExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> AdditiveExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<AdditiveExpressionContextAll<'input>> {
		Rc::new(
...
pub trait AdditiveExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<AdditiveExpressionContextExt<'input>>{
...
fn Plus_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn Plus(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(Plus, i)
}
/// Retrieves all `TerminalNode`s corresponding to token Minus in current rule
fn Minus_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn Minus(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for ShiftExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ShiftExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ShiftExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ShiftExpressionContextAll<'input>> {
		Rc::new(
...
pub trait ShiftExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ShiftExpressionContextExt<'input>>{
...
fn LeftShift_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn LeftShift(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(LeftShift, i)
}
/// Retrieves all `TerminalNode`s corresponding to token RightShift in current rule
fn RightShift_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn RightShift(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for RelationalExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for RelationalExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> RelationalExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<RelationalExpressionContextAll<'input>> {
		Rc::new(
...
pub trait RelationalExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<RelationalExpressionContextExt<'input>>{
...
fn Less_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn Less(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(Less, i)
}
/// Retrieves all `TerminalNode`s corresponding to token Greater in current rule
fn Greater_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn Greater(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(Greater, i)
}
/// Retrieves all `TerminalNode`s corresponding to token LessEqual in current rule
fn LessEqual_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn LessEqual(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(LessEqual, i)
}
/// Retrieves all `TerminalNode`s corresponding to token GreaterEqual in current rule
fn GreaterEqual_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn GreaterEqual(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for EqualityExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for EqualityExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> EqualityExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<EqualityExpressionContextAll<'input>> {
		Rc::new(
...
pub trait EqualityExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<EqualityExpressionContextExt<'input>>{
...
fn Equal_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn Equal(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(Equal, i)
}
/// Retrieves all `TerminalNode`s corresponding to token NotEqual in current rule
fn NotEqual_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn NotEqual(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for AndExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for AndExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> AndExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<AndExpressionContextAll<'input>> {
		Rc::new(
...
pub trait AndExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<AndExpressionContextExt<'input>>{
...
fn And_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn And(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for ExclusiveOrExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ExclusiveOrExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ExclusiveOrExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ExclusiveOrExpressionContextAll<'input>> {
		Rc::new(
...
pub trait ExclusiveOrExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ExclusiveOrExpressionContextExt<'input>>{
...
fn Caret_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn Caret(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for InclusiveOrExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for InclusiveOrExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> InclusiveOrExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<InclusiveOrExpressionContextAll<'input>> {
		Rc::new(
...
pub trait InclusiveOrExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<InclusiveOrExpressionContextExt<'input>>{
...
fn Or_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn Or(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(Or, i)
}
...
impl<'input> generatorParserContext<'input> for LogicalAndExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for LogicalAndExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> LogicalAndExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<LogicalAndExpressionContextAll<'input>> {
		Rc::new(
...
pub trait LogicalAndExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<LogicalAndExpressionContextExt<'input>>{
...
fn AndAnd_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn AndAnd(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for LogicalOrExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for LogicalOrExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> LogicalOrExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<LogicalOrExpressionContextAll<'input>> {
		Rc::new(
...
pub trait LogicalOrExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<LogicalOrExpressionContextExt<'input>>{
...
fn OrOr_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn OrOr(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for ConditionalExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ConditionalExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ConditionalExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ConditionalExpressionContextAll<'input>> {
		Rc::new(
...
pub trait ConditionalExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ConditionalExpressionContextExt<'input>>{
...
fn Question(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for AssignmentExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for AssignmentExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> AssignmentExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<AssignmentExpressionContextAll<'input>> {
		Rc::new(
...
pub trait AssignmentExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<AssignmentExpressionContextExt<'input>>{
...
fn DigitSequence(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for AssignmentOperatorContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for AssignmentOperatorContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> AssignmentOperatorContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<AssignmentOperatorContextAll<'input>> {
		Rc::new(
...
pub trait AssignmentOperatorContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<AssignmentOperatorContextExt<'input>>{
...
fn Assign(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn MulAssign(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn DivAssign(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn ModAssign(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn PlusAssign(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn MinusAssign(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn LeftShiftAssign(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn RightShiftAssign(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn AndAssign(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn XorAssign(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn OrAssign(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for ExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ExpressionContextAll<'input>> {
		Rc::new(
...
pub trait ExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ExpressionContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for ConstantExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ConstantExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ConstantExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ConstantExpressionContextAll<'input>> {
		Rc::new(
...
pub trait ConstantExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ConstantExpressionContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for DeclarationContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for DeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> DeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DeclarationContextAll<'input>> {
		Rc::new(
...
pub trait DeclarationContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<DeclarationContextExt<'input>>{
...
fn Semi(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for DeclarationSpecifiersContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for DeclarationSpecifiersContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> DeclarationSpecifiersContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DeclarationSpecifiersContextAll<'input>> {
		Rc::new(
...
pub trait DeclarationSpecifiersContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<DeclarationSpecifiersContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for DeclarationSpecifiers2Context<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for DeclarationSpecifiers2Context<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> DeclarationSpecifiers2ContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DeclarationSpecifiers2ContextAll<'input>> {
		Rc::new(
...
pub trait DeclarationSpecifiers2ContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<DeclarationSpecifiers2ContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for DeclarationSpecifierContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for DeclarationSpecifierContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> DeclarationSpecifierContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DeclarationSpecifierContextAll<'input>> {
		Rc::new(
...
pub trait DeclarationSpecifierContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<DeclarationSpecifierContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for InitDeclaratorListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for InitDeclaratorListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> InitDeclaratorListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<InitDeclaratorListContextAll<'input>> {
		Rc::new(
...
pub trait InitDeclaratorListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<InitDeclaratorListContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for InitDeclaratorContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for InitDeclaratorContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> InitDeclaratorContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<InitDeclaratorContextAll<'input>> {
		Rc::new(
...
pub trait InitDeclaratorContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<InitDeclaratorContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for StorageClassSpecifierContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for StorageClassSpecifierContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> StorageClassSpecifierContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StorageClassSpecifierContextAll<'input>> {
		Rc::new(
...
pub trait StorageClassSpecifierContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<StorageClassSpecifierContextExt<'input>>{
...
fn Typedef(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Extern(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Static(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn ThreadLocal(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Auto(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Register(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for TypeSpecifierContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for TypeSpecifierContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> TypeSpecifierContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TypeSpecifierContextAll<'input>> {
		Rc::new(
...
pub trait TypeSpecifierContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<TypeSpecifierContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token Void
/// Returns `None` if there is no child corresponding to token Void
fn Void(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Char(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Short(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(Short, 0)
}
/// Retrieves first TerminalNode corresponding to token Int
/// Returns `None` if there is no child corresponding to token Int
fn Int(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Long(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Float(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Double(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Signed(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Unsigned(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Bool(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Complex(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for StructOrUnionSpecifierContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for StructOrUnionSpecifierContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> StructOrUnionSpecifierContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StructOrUnionSpecifierContextAll<'input>> {
		Rc::new(
...
pub trait StructOrUnionSpecifierContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<StructOrUnionSpecifierContextExt<'input>>{
...
fn LeftBrace(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn RightBrace(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for StructOrUnionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for StructOrUnionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> StructOrUnionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StructOrUnionContextAll<'input>> {
		Rc::new(
...
pub trait StructOrUnionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<StructOrUnionContextExt<'input>>{
...
fn Struct(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Union(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for StructDeclarationListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for StructDeclarationListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> StructDeclarationListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StructDeclarationListContextAll<'input>> {
		Rc::new(
...
pub trait StructDeclarationListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<StructDeclarationListContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for StructDeclarationContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for StructDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> StructDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StructDeclarationContextAll<'input>> {
		Rc::new(
...
pub trait StructDeclarationContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<StructDeclarationContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for SpecifierQualifierListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for SpecifierQualifierListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> SpecifierQualifierListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SpecifierQualifierListContextAll<'input>> {
		Rc::new(
...
pub trait SpecifierQualifierListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<SpecifierQualifierListContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for StructDeclaratorListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for StructDeclaratorListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> StructDeclaratorListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StructDeclaratorListContextAll<'input>> {
		Rc::new(
...
pub trait StructDeclaratorListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<StructDeclaratorListContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for StructDeclaratorContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for StructDeclaratorContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> StructDeclaratorContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StructDeclaratorContextAll<'input>> {
		Rc::new(
...
pub trait StructDeclaratorContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<StructDeclaratorContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for EnumSpecifierContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for EnumSpecifierContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> EnumSpecifierContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<EnumSpecifierContextAll<'input>> {
		Rc::new(
...
pub trait EnumSpecifierContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<EnumSpecifierContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token Enum
/// Returns `None` if there is no child corresponding to token Enum
fn Enum(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for EnumeratorListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for EnumeratorListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> EnumeratorListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<EnumeratorListContextAll<'input>> {
		Rc::new(
...
pub trait EnumeratorListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<EnumeratorListContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for EnumeratorContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for EnumeratorContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> EnumeratorContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<EnumeratorContextAll<'input>> {
		Rc::new(
...
pub trait EnumeratorContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<EnumeratorContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for EnumerationConstantContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for EnumerationConstantContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> EnumerationConstantContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<EnumerationConstantContextAll<'input>> {
		Rc::new(
...
pub trait EnumerationConstantContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<EnumerationConstantContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for AtomicTypeSpecifierContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for AtomicTypeSpecifierContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> AtomicTypeSpecifierContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<AtomicTypeSpecifierContextAll<'input>> {
		Rc::new(
...
pub trait AtomicTypeSpecifierContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<AtomicTypeSpecifierContextExt<'input>>{
...
fn Atomic(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for TypeQualifierContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for TypeQualifierContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> TypeQualifierContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TypeQualifierContextAll<'input>> {
		Rc::new(
...
pub trait TypeQualifierContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<TypeQualifierContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token Const
/// Returns `None` if there is no child corresponding to token Const
fn Const(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Restrict(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Volatile(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for FunctionSpecifierContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for FunctionSpecifierContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> FunctionSpecifierContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FunctionSpecifierContextAll<'input>> {
		Rc::new(
...
pub trait FunctionSpecifierContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<FunctionSpecifierContextExt<'input>>{
...
fn Inline(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn Noreturn(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for AlignmentSpecifierContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for AlignmentSpecifierContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> AlignmentSpecifierContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<AlignmentSpecifierContextAll<'input>> {
		Rc::new(
...
pub trait AlignmentSpecifierContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<AlignmentSpecifierContextExt<'input>>{
...
fn Alignas(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for DeclaratorContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for DeclaratorContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> DeclaratorContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DeclaratorContextAll<'input>> {
		Rc::new(
...
pub trait DeclaratorContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<DeclaratorContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for DirectDeclaratorContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for DirectDeclaratorContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> DirectDeclaratorContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DirectDeclaratorContextAll<'input>> {
		Rc::new(
...
pub trait DirectDeclaratorContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<DirectDeclaratorContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for VcSpecificModiferContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for VcSpecificModiferContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> VcSpecificModiferContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<VcSpecificModiferContextAll<'input>> {
		Rc::new(
...
pub trait VcSpecificModiferContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<VcSpecificModiferContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for NestedParenthesesBlockContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for NestedParenthesesBlockContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> NestedParenthesesBlockContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<NestedParenthesesBlockContextAll<'input>> {
		Rc::new(
...
pub trait NestedParenthesesBlockContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<NestedParenthesesBlockContextExt<'input>>{

/// Retrieves all `TerminalNode`s corresponding to token LeftParen in current rule
fn LeftParen_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn LeftParen(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
fn RightParen_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn RightParen(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for PointerContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for PointerContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> PointerContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<PointerContextAll<'input>> {
		Rc::new(
...
pub trait PointerContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<PointerContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for TypeQualifierListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for TypeQualifierListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> TypeQualifierListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TypeQualifierListContextAll<'input>> {
		Rc::new(
...
pub trait TypeQualifierListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<TypeQualifierListContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for ParameterTypeListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ParameterTypeListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ParameterTypeListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ParameterTypeListContextAll<'input>> {
		Rc::new(
...
pub trait ParameterTypeListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ParameterTypeListContextExt<'input>>{
...
fn Ellipsis(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for ParameterListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ParameterListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ParameterListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ParameterListContextAll<'input>> {
		Rc::new(
...
pub trait ParameterListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ParameterListContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for ParameterDeclarationContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ParameterDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ParameterDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ParameterDeclarationContextAll<'input>> {
		Rc::new(
...
pub trait ParameterDeclarationContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ParameterDeclarationContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for IdentifierListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for IdentifierListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> IdentifierListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<IdentifierListContextAll<'input>> {
		Rc::new(
...
pub trait IdentifierListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<IdentifierListContextExt<'input>>{

/// Retrieves all `TerminalNode`s corresponding to token Identifier in current rule
fn Identifier_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn Identifier(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for TypeNameContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for TypeNameContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> TypeNameContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TypeNameContextAll<'input>> {
		Rc::new(
...
pub trait TypeNameContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<TypeNameContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for AbstractDeclaratorContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for AbstractDeclaratorContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> AbstractDeclaratorContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<AbstractDeclaratorContextAll<'input>> {
		Rc::new(
...
pub trait AbstractDeclaratorContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<AbstractDeclaratorContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for DirectAbstractDeclaratorContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for DirectAbstractDeclaratorContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> DirectAbstractDeclaratorContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DirectAbstractDeclaratorContextAll<'input>> {
		Rc::new(
...
pub trait DirectAbstractDeclaratorContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<DirectAbstractDeclaratorContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for TypedefNameContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for TypedefNameContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> TypedefNameContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TypedefNameContextAll<'input>> {
		Rc::new(
...
pub trait TypedefNameContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<TypedefNameContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for InitializerContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for InitializerContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> InitializerContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<InitializerContextAll<'input>> {
		Rc::new(
...
pub trait InitializerContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<InitializerContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for InitializerListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for InitializerListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> InitializerListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<InitializerListContextAll<'input>> {
		Rc::new(
...
pub trait InitializerListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<InitializerListContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for DesignationContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for DesignationContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> DesignationContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DesignationContextAll<'input>> {
		Rc::new(
...
pub trait DesignationContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<DesignationContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for DesignatorListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for DesignatorListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> DesignatorListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DesignatorListContextAll<'input>> {
		Rc::new(
...
pub trait DesignatorListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<DesignatorListContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for DesignatorContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for DesignatorContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> DesignatorContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DesignatorContextAll<'input>> {
		Rc::new(
...
pub trait DesignatorContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<DesignatorContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for StaticAssertDeclarationContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for StaticAssertDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> StaticAssertDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StaticAssertDeclarationContextAll<'input>> {
		Rc::new(
...
pub trait StaticAssertDeclarationContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<StaticAssertDeclarationContextExt<'input>>{
...
fn StaticAssert(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for StatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for StatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> StatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StatementContextAll<'input>> {
		Rc::new(
...
pub trait StatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<StatementContextExt<'input>>{
...
fn Colon_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn Colon(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for LabeledStatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for LabeledStatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> LabeledStatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<LabeledStatementContextAll<'input>> {
		Rc::new(
...
pub trait LabeledStatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<LabeledStatementContextExt<'input>>{
...
fn Case(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for CompoundStatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for CompoundStatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> CompoundStatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<CompoundStatementContextAll<'input>> {
		Rc::new(
...
pub trait CompoundStatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<CompoundStatementContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for BlockItemListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for BlockItemListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> BlockItemListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<BlockItemListContextAll<'input>> {
		Rc::new(
...
pub trait BlockItemListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<BlockItemListContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for BlockItemContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for BlockItemContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> BlockItemContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<BlockItemContextAll<'input>> {
		Rc::new(
...
pub trait BlockItemContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<BlockItemContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for ExpressionStatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ExpressionStatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ExpressionStatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ExpressionStatementContextAll<'input>> {
		Rc::new(
...
pub trait ExpressionStatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ExpressionStatementContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for SelectionStatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for SelectionStatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> SelectionStatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SelectionStatementContextAll<'input>> {
		Rc::new(
...
pub trait SelectionStatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<SelectionStatementContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for IfSelectionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for IfSelectionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> IfSelectionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<IfSelectionContextAll<'input>> {
		Rc::new(
...
pub trait IfSelectionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<IfSelectionContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token If
/// Returns `None` if there is no child corresponding to token If
fn If(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(If, 0)
}
/// Retrieves first TerminalNode corresponding to token LeftParen
/// Returns `None` if there is no child corresponding to token LeftParen
...
fn Else(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for SwitchSelectionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for SwitchSelectionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> SwitchSelectionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SwitchSelectionContextAll<'input>> {
		Rc::new(
...
pub trait SwitchSelectionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<SwitchSelectionContextExt<'input>>{
...
fn Switch(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for IterationStatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for IterationStatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> IterationStatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<IterationStatementContextAll<'input>> {
		Rc::new(
...
pub trait IterationStatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<IterationStatementContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for ForIterationStatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ForIterationStatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ForIterationStatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ForIterationStatementContextAll<'input>> {
		Rc::new(
...
pub trait ForIterationStatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ForIterationStatementContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token For
/// Returns `None` if there is no child corresponding to token For
fn For(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for WhileIterationStatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for WhileIterationStatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> WhileIterationStatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<WhileIterationStatementContextAll<'input>> {
		Rc::new(
...
pub trait WhileIterationStatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<WhileIterationStatementContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token While
/// Returns `None` if there is no child corresponding to token While
fn While(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for DoWhileIterationStatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for DoWhileIterationStatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> DoWhileIterationStatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DoWhileIterationStatementContextAll<'input>> {
		Rc::new(
...
pub trait DoWhileIterationStatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<DoWhileIterationStatementContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token Do
/// Returns `None` if there is no child corresponding to token Do
fn Do(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
	self.get_token(Do, 0)
}
fn statement(&self) -> Option<Rc<StatementContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
impl<'input> generatorParserContext<'input> for ForConditionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ForConditionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ForConditionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ForConditionContextAll<'input>> {
		Rc::new(
...
pub trait ForConditionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ForConditionContextExt<'input>>{
...
fn Semi_all(&self) -> Vec<Rc<TerminalNode<'input,generatorParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn Semi(&self, i: usize) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for ForDeclarationContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ForDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ForDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ForDeclarationContextAll<'input>> {
		Rc::new(
...
pub trait ForDeclarationContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ForDeclarationContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for ForBeforeExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ForBeforeExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ForBeforeExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ForBeforeExpressionContextAll<'input>> {
		Rc::new(
...
pub trait ForBeforeExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ForBeforeExpressionContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for ForAfterExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ForAfterExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ForAfterExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ForAfterExpressionContextAll<'input>> {
		Rc::new(
...
pub trait ForAfterExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ForAfterExpressionContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for ForMidExpressionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ForMidExpressionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ForMidExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ForMidExpressionContextAll<'input>> {
		Rc::new(
...
pub trait ForMidExpressionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ForMidExpressionContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for JumpStatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for JumpStatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> JumpStatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<JumpStatementContextAll<'input>> {
		Rc::new(
...
pub trait JumpStatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<JumpStatementContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for BreakpointStatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for BreakpointStatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> BreakpointStatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<BreakpointStatementContextAll<'input>> {
		Rc::new(
...
pub trait BreakpointStatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<BreakpointStatementContextExt<'input>>{
...
fn Breakpoint(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for BreakpointArgContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for BreakpointArgContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> BreakpointArgContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<BreakpointArgContextAll<'input>> {
		Rc::new(
...
pub trait BreakpointArgContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<BreakpointArgContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for ContinueStatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ContinueStatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ContinueStatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ContinueStatementContextAll<'input>> {
		Rc::new(
...
pub trait ContinueStatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ContinueStatementContextExt<'input>>{
...
fn Continue(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for BreakStatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for BreakStatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> BreakStatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<BreakStatementContextAll<'input>> {
		Rc::new(
...
pub trait BreakStatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<BreakStatementContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token Break
/// Returns `None` if there is no child corresponding to token Break
fn Break(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for ReturnStatementContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ReturnStatementContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ReturnStatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ReturnStatementContextAll<'input>> {
		Rc::new(
...
pub trait ReturnStatementContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ReturnStatementContextExt<'input>>{
...
fn Return(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for CompilationUnitContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for CompilationUnitContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> CompilationUnitContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<CompilationUnitContextAll<'input>> {
		Rc::new(
...
pub trait CompilationUnitContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<CompilationUnitContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token EOF
/// Returns `None` if there is no child corresponding to token EOF
fn EOF(&self) -> Option<Rc<TerminalNode<'input,generatorParserContextType>>> where Self:Sized{
...
impl<'input> generatorParserContext<'input> for TranslationUnitContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for TranslationUnitContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> TranslationUnitContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TranslationUnitContextAll<'input>> {
		Rc::new(
...
pub trait TranslationUnitContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<TranslationUnitContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for ExternalDeclarationContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for ExternalDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> ExternalDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ExternalDeclarationContextAll<'input>> {
		Rc::new(
...
pub trait ExternalDeclarationContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<ExternalDeclarationContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for FunctionDefinitionContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for FunctionDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> FunctionDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FunctionDefinitionContextAll<'input>> {
		Rc::new(
...
pub trait FunctionDefinitionContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<FunctionDefinitionContextExt<'input>>{
...
impl<'input> generatorParserContext<'input> for DeclarationListContext<'input>{}

impl<'input,'a> Listenable<dyn generatorListener<'input> + 'a> for DeclarationListContext<'input>{
		fn enter(&self,listener: &mut (dyn generatorListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> DeclarationListContextExt<'input>{
	fn new(parent: Option<Rc<dyn generatorParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DeclarationListContextAll<'input>> {
		Rc::new(
...
pub trait DeclarationListContextAttrs<'input>: generatorParserContext<'input> + BorrowMut<DeclarationListContextExt<'input>>{
